...
import AnswerBox from './components/Character'
import FailBox from './components/Failed'
import Result from './components/Result'
import Human from './components/Man'
import {
  Gallow,
  DownPipe,
  RightBlueTriangle,
...
export default () => {
  ...
  return (
    <AppWrapper>
      <GameInstruction>Press Keys to Play.</GameInstruction>
      ...
      />
      {!isPaused && <Button pause> Pause </Button>}
    </AppWrapper>
  )
}
